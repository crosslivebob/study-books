...
public class ConstructorResolver {
    ...
    public Object autowireConstructor(final BeanDefinition bd) {
        ...
        for (Constructor<?> cst : candidates) {
    ...
    public boolean valuesMatchTypes(Class<?>[] parameterTypes, List<ConstructorArgument.ValueHolder> valueHolders,
